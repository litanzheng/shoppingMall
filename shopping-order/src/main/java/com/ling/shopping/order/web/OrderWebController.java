package com.ling.shopping.order.web;
...
import com.ling.shopping.order.vo.OrderConfirmVo;
import com.ling.shopping.order.vo.OrderSubmitVo;
import com.ling.shopping.order.vo.SubmitOrderResponseVo;
    ...
    public String submitOrder(OrderSubmitVo submitVo, Model model, RedirectAttributes attributes) {
        try{
            ...
            if (code==0){
                ...
                return "redirect:http://order.shopping.com/toTrade";
            }
        }catch (Exception e){
