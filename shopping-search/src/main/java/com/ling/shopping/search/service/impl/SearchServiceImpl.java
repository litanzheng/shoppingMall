package com.ling.shopping.search.service.impl;
...
import com.ling.shopping.search.vo.AttrResponseVo;
    ...
    private SearchResult bulidSearchResult(SearchParam searchParam, SearchResponse searchResponse) {
        ...
        if (attrs != null && attrs.size() > 0) {
            List<SearchResult.NavVo> navVos = attrs.stream().map(attr -> {
                ...
                navVo.setLink("http://search.shopping.com/search.html" + (replace.isEmpty()?"":"?"+replace));
                return navVo;
