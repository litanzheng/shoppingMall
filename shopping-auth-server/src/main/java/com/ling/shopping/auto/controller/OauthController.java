package com.ling.shopping.auto.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.ling.shopping.common.constant.AuthServerConstant;
import com.ling.shopping.common.utils.HttpUtils;
...
public class OauthController {
    ...
    public String authorize(String code, HttpSession session) throws Exception {
        ...
        query.put("redirect_uri", "http://auth.shopping.com/oauth2.0/weibo/success");
        query.put("code", code);
        //发送post请求换取token
        ...
        if (response.getStatusLine().getStatusCode() == 200) {
            ...
            if (login.getCode() == 0) {
                ...
                return "redirect:http://shopping.com";
            }else {
                //2.2 否则返回登录页
                errors.put("msg", "登录失败，请重试");
                session.setAttribute("errors", errors);
                return "redirect:http://auth.shopping.com/login.html";
            }
        }else {
